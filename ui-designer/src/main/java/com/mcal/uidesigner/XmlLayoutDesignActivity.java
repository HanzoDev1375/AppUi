...
import com.mcal.uidesigner.interfaces.LayoutPast;
...
public class XmlLayoutDesignActivity extends AppCompatActivity implements LayoutPast {
  ...
  public static String xmlLayout;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    DrawerLayout layout = findViewById(R.id.designerDrawer);
    layout.addDrawerListener(
        new DrawerLayout.DrawerListener() {
          @Override
          public void onDrawerSlide(View drawerView, float slideOffset) {
            View getView = findViewById(R.id.designerFrame);
  ...
  public void createInflater() {
    ...
    this.inflater =
        new XmlLayoutlInflater(
            this.containerView, this.xmlFilePath, this.resDirPath, this.undoManager, this) {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (item.getItemId() == 16908332) {
      ...
      this.inflater.share();
    } else if (item.getItemId() == R.id.showXmlCode) {
      new MaterialAlertDialogBuilder(this)
          .setTitle("XmlView")
          .setMessage(inflater.getXml())
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (entry.view != null) {
        ...
        viewLayout.setPadding(
            ...
            0,
            0);
        ((TextView) view.findViewById(R.id.designerViewlistEntryName))
            .setText(entry.view.getNodeName());
  ...
  @Override
  public void onPastLayout(String text) {
